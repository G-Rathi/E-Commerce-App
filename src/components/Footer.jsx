...
import { mobile, bmobile, tablet } from "../Responsive";
                ...
                <Container>
                        ...
                        <Center>
                                ...
                                <List>
                                        ...
                                        <ListItem><Link to='/products' style={{ textDecoration: 'none', color: 'white' }}>Man Fashion</Link></ListItem>
                                        <ListItem><Link to='/products' style={{ textDecoration: 'none', color: 'white' }}>Woman Fashion</Link></ListItem>
                                        <ListItem><Link to='/products' style={{ textDecoration: 'none', color: 'white' }}>Accessories</Link></ListItem>
                                        <ListItem><Link to='/' style={{ textDecoration: 'none', color: 'white' }}>My Account</Link></ListItem>
                                        <ListItem><Link to='/' style={{ textDecoration: 'none', color: 'white' }}>Order Tracking</Link></ListItem>
                                        <ListItem><Link to='/' style={{ textDecoration: 'none', color: 'white' }}>Wishlist</Link></ListItem>
